			...
			<div class="container-fluid">
				...
				<form action="" id="manage-user">	
					...
					<div class="row">
						...
						<div class="form-group col-md-6">
							<label for="firstname" class="control-label">Shop Firstname</label>
						...
						<div class="form-group col-md-6">
							<label for="lastname" class="control-label">Shop Lastname</label>
							<input type="text" id="lastname" autofocus name="lastname" class="form-control form-control-sm form-control-border" value="<?= isset($lastname) ? $lastname : "" ?>" required>
						</div>
						<div class="form-group col-md-6">
							<label for="middlename" class="control-label">Shop Middlename</label>
							<input type="text" id="middlename" autofocus name="middlename" class="form-control form-control-sm form-control-border" value="<?= isset($middlename) ? $middlename : "" ?>" placeholder="(optional)">
						</div>
					...
					<div class="row">
						<div class="form-group col-md-6">
							...
							<input type="file" id="logo" name="img" class="form-control form-control-sm form-control-border" onchange="displayImg(this,$(this),'cimg')" accept="image/png, image/jpeg">
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="form-group col-md-6">
							<label for="business_permit" class="control-label">Business Permit</label>
							<input type="file" id="business_permit" name="business_permit" class="form-control form-control-sm form-control-border" onchange="displayImg(this,$(this),'permit')" accept="image/png, image/jpeg">
						</div>
					</div>
					<div class="row">
						<div class="form-group col-md-6 text-center">
							<img src="<?= validate_image(isset($business_permit) ? $business_permit : "") ?>" alt="Business Permit" id="permit" class="border border-gray img-thumbnail">
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group col-md-4">
							...
							<option value="0" <?= isset($status) && $status == 0 ? 'selected' : '' ?>>Pending</option>
								...
								<option value="2" <?= isset($status) && $status == 2 ? 'selected' : '' ?>>Declined</option>
                            </select>
                        </div>
					</div>

					<div class="row" id="declined_form" style="display: <?=$status == 2 ? "block" : "none" ?> ;">
						<div class="form-group col-md-4">
                            <label for="status" class="control-label">Decline Message</label>
                            <Textarea name="declined" class="form-control"><?=$declined ?? "" ?></Textarea>
                        </div>
					</div>
				</form>
			</div>
...
<script>
	function displayImg(input,_this,id) {
	    if (input.files && input.files[0]) {
			...
			$('g').attr('src', "<?= validate_image(isset($avatar) ? $avatar : "") ?>");
		}
	}
