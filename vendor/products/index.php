        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT * from `$product_list_table` where delete_flag = 0 and `vendor_id` = '{$_settings->userdata('id')}' order by `name` asc ");
					...
					?>
						<tr>
							...
							<td class="text-center">
                                ...
                                <?php else: ?>
                                    <span class="badge badge-danger bg-gradient-danger px-3 rounded-pill">Not Available</span>
                                <?php endif; ?>
                            </td>
							<td align="center">
