...
<body class="hold-transition">
  ...
  <div class="d-flex justify-content-center align-items-center flex-row h-100" style="overflow-y: auto;">
        <div class="col-5">
                    ...
                    <input type="hidden" id="module" name="module" value="<?=$_GET['module']?>" >
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="postal_code" name="postal_code" class="form-control form-control-sm form-control-border" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="file" id="business_permit" name="business_permit" class="form-control form-control-sm form-control-border" onchange="Permit(this,$(this))" accept="image/png, image/jpeg" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6 text-center">
                                <img src="<?= validate_image('') ?>" alt="Business Permit" id="permit" class="border border-gray img-thumbnail">
                            </div>
                        </div>
                            </div>
                        </div>
...
<script>
    ...
    function Permit(input,_this) {
	    if (input.files && input.files[0]) {
	        var reader = new FileReader();
	        reader.onload = function (e) {
	        	$('#permit').attr('src', e.target.result);
	        }

	        reader.readAsDataURL(input.files[0]);
	    }else{
	        	$('#permit').attr('src', '<?= validate_image('') ?>');
        }
	}
  $(function(){
    end_loader();
