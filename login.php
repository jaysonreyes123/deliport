        ...
        <div class="row align-item-end">
          ...
          <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item" href="<?= base_url.'register.php' ?>">Customer</a>
                  <a class="dropdown-item" href="<?= base_url.'vendor/register.php' ?>">Seller/Supplier</a>
                  <!-- <a class="dropdown-item" href="<?= base_url.'vendor/register.php?module=supplier' ?>">Supplier</a> -->
                </div>
              </div>
          </div>
          <!-- /.col -->
...
<input type="hidden" value="<?=base_url?>" id="site_url">
...
<script>
  ...
  $(function(){
    ...
    $('#cclogin-frm').submit(function(e){
        ...
        start_loader();
        $.ajax({
            url:_base_url_+"classes/Login.php?f=check_login",
            ...
            success:function(resp){
                ...
                if(typeof resp =='object' && resp.status == 'success'){
                    if(resp.user_level == 'client'){
                      location.href= './';
                    }
                    else if(resp.user_level == 'vendor'){
                      location.href= site_url+'vendor';
                    }
                    else if(resp.user_level == 'admin'){
