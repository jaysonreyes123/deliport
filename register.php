                    ...
                    <form id="cregister-frm" action="" method="post">
                        ...
                        <!-- <div class="row">
                            <div class="form-group col-md-12">
                                <label for="address" class="control-label">Complete Address [House No] [Street] [Barangay], [Municipality], [Province]</label>
                                <textarea rows="3" id="address" name="address" class="form-control form-control-sm rounded-0" required></textarea>
                            </div>
                        </div> -->
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label for="House No" class="control-label">House No</label>
                                <input type="text" id="house_no" autofocus name="house_no" class="form-control form-control-sm form-control-border" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="street" class="control-label">Street</label>
                                <input type="text" id="street" name="street" class="form-control form-control-sm form-control-border" placeholder="optional">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="barangay" class="control-label">Barangay</label>
                                <input type="text" id="barangay" name="barangay" class="form-control form-control-sm form-control-border" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="municipality" class="control-label">Municipality</label>
                                <input type="text" id="municipality" name="municipality" class="form-control form-control-sm form-control-border" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="province" class="control-label">Province</label>
                                <input type="text" id="province" name="province" class="form-control form-control-sm form-control-border" required>
                            </div>
                        </div>
                        <div class="row">
