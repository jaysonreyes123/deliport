                ...
                <div class="card-body">
                    <div class="container-fluid">
                        ...
                        <div class="row" id="product_list">
                            ...
                            $products = $conn->query("SELECT p.*, v.shop_name as vendor, c.name as `category` FROM `product_list` p inner join vendor_list v on p.vendor_id = v.id inner join category_list c on p.category_id = c.id where p.delete_flag = 0 and c.shop_type = '{$shop_type}' and p.`status` =1 {$swhere} order by RAND()");
...
<script>
    $(function(){
        ...
        $('.cat_item').change(function(){
            ...
            location.href="./?page=products&shop_type="+$("#shop_type").val()+"&cids="+(ids.join(","))
        })

        $("#shop_type").change(function(){
            location.href="./?page=products&shop_type="+$("#shop_type").val();
        })
