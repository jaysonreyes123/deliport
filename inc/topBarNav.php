        ...
        <div class="d-flex justify-content-between w-100">
          ...
          <div>
            ...
            <?php else: ?>
              ...
              <a href="./vendor" class="mx-2 text-light text-decoration-none font-weight-bolder">Supplier Login</a> |  
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <?php
                    $notification_count = $conn->query("SELECT count(is_read) FROM `notification` where client_id = '{$_settings->userdata('id')}' and is_read = 0 " )->fetch_array()[0];
                    $notification_count = $notification_count > 0 ? $notification_count : 0;
                ?>
                <a href="./?page=orders/notification" class="nav-link <?= isset($page) && $page =='orders/notification' ? "active" : "" ?>"><span class="badge badge-secondary rounded-cirlce" id="notification_count"><?= format_num($notification_count) ?></span> Notification</a>
              </li>
              <?php endif; ?> 
            </ul>
          </div>
