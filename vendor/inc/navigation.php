              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   ...
                   <li class="nav-item dropdown">
                    <a href="<?php echo base_url ?>vendor/?page=takeorder" class="nav-link nav-takeorder">
                   ...
                   <li class="nav-item dropdown">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>vendor/?page=supplies" class="nav-link nav-supplies">
                         <i class="nav-icon fas fa-list"></i>
                        <p>
                          Supplies
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>vendor/?page=request" class="nav-link nav-request">
                         <i class="nav-icon fas fa-list"></i>
                        <p>
                          Request List
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>vendor/?page=map" class="nav-link nav-map">
                         <i class="nav-icon fas fa-list"></i>
                        <p>
                          Map
                        </p>
