...
#map { position: relative; top: 10px; bottom: 0; width: 100%;height: 400px; }
      ...
      <?php
        $store_list = $conn->query("SELECT * from vendor_list where is_supplier = 0 and `status` = 1 and delete_flag = 0 ");
        $store_list_ = array();
...
<div class="content py-3">
    <div class="card card-outline card-primary shadow rounded-0">
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-id="0" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Order Now</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-id="1" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Pre-Order</a>
                        </li>
                    </ul>
            <div class="row">
