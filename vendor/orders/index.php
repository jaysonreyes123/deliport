<?php 
 $table = $_settings->userdata('is_supplier') == 1 ? "order_list_vendor" : "order_list";
?>
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php 
                    $i = 1;
                    $orders = $conn->query("SELECT * FROM `$table` where vendor_id = '{$_settings->userdata('id')}' order by `status` asc,unix_timestamp(date_created) desc ");
