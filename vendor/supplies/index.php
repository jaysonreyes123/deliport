							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
									...
									<div class="dropdown-divider"></div>
				                    <!-- <a class="dropdown-item request_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>" data-supplier_id = "<?=$row['supplier_id']?>" ><span class="fa fa-edit text-warning"></span> Request</a>
				                    <div class="dropdown-divider"></div> -->
...
<script>
	$(document).ready(function(){
		$('#create_new').click(function(){
			uni_modal('Add New Product',"supplies/manage_product.php",'large')
		})
		$('.view_data').click(function(){
			uni_modal('View Product Details',"supplies/view_product.php?id="+$(this).attr('data-id'),'large')
		})
		$('.edit_data').click(function(){
			uni_modal('Update Product',"supplies/manage_product.php?id="+$(this).attr('data-id'),'large')
		})

		// $('.request_data').click(function(){
		// 	uni_modal('Request',"supplies/manage_request.php?id="+$(this).attr('data-id')+"&supplier_id="+$(this).attr('data-supplier_id'),'large')
		// })
