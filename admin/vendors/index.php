					...
					?>
						<tr>
							...
							<td class="text-center">
								<?php if($row['status'] == 1): ?>
									<span class="bage badge-success px-3 rounded-pill">Approved</span>
								<?php elseif($row["status"] == 2): ?>
									<span class="bage badge-danger px-3 rounded-pill">Declined</span>
								<?php else:?>
									<span class="bage badge-primary px-3 rounded-pill">Pending</span>
								<?php endif; ?>
							</td>
							<td align="center">
